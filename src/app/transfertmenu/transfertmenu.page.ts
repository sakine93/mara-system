...
@Component({
  selector: 'app-transfertmenu',
  templateUrl: './transfertmenu.page.html',
  styleUrls: ['./transfertmenu.page.scss'],
})
export class TransfertmenuPage implements OnInit {
    ...
    return new Promise(resolve => {
      ...
      this.postPvdr.postData(body4, 'file_aksi.php').subscribe(data => {
        for (let customer of data.result) {
          ...
          this.totalpts = (customer.totalpts);
        this.totalkhaliss = customer.totalpts*65.5;
