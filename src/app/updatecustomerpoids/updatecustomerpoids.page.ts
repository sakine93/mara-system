...
@Component({
  selector: 'app-updatecustomerpoids',
  templateUrl: './updatecustomerpoids.page.html',
  styleUrls: ['./updatecustomerpoids.page.scss'],
})
export class UpdatecustomerpoidsPage implements OnInit {
