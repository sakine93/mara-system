...
@Component({
  selector: 'app-bijouxmanquants',
  templateUrl: './bijouxmanquants.page.html',
  styleUrls: ['./bijouxmanquants.page.scss'],
})
export class BijouxmanquantsPage implements OnInit {
...
text:"Annuler",handler:(res)=>{
  ...
  async openPreview(pic_filename) {
